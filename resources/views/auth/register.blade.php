...
<div id="text">
    <img id="img" src="{{asset('img/erro_superpao.png')}}" align="right" width="40%">
    <p><strong>Devido as políticas de segurança da empresa este site endereço bloqueado.</strong></p>
